...
class Main_Class(FloatLayout):
    ...
    def OnSlider(self, instance, slider_value):
            ...
            if self.Slider_1.value == 0:
                self.Test1.background_color=(0,0,0,255)
                self.Test2.background_color=(0,0,0,255)
                self.Test3.background_color=(0,0,0,255)
                self.Test4.background_color=(0,0,0,255)
                self.Test5.background_color=(0,0,0,255)

            elif self.Slider_1.value == 20:
                self.Test1.background_color=(255,0,0,255)
                self.Test2.background_color=(0,0,0,255)
                self.Test3.background_color=(0,0,0,255)
                self.Test4.background_color=(0,0,0,255)
                self.Test5.background_color=(0,0,0,255)
                ...
                self.Test1.background_color=(255,0,0,255)
                self.Test2.background_color=(255,0,0,255)
                self.Test3.background_color=(0,0,0,255)
                self.Test4.background_color=(0,0,0,255)
                self.Test5.background_color=(0,0,0,255)
                ...
                self.Test1.background_color=(255,0,0,255)
                self.Test2.background_color=(255,0,0,255)
                self.Test3.background_color=(255,0,0,255)
                self.Test4.background_color=(0,0,0,255)
                self.Test5.background_color=(0,0,0,255)
                ...
                self.Test2.background_color=(255,0,0,255)
                self.Test3.background_color=(255,0,0,255)
                self.Test4.background_color=(255,0,0,255)
                self.Test5.background_color=(0,0,0,255)
                ...
                self.Test3.background_color=(255,0,0,255)
                self.Test4.background_color=(255,0,0,255)
                self.Test5.background_color=(255,0,0,255)
